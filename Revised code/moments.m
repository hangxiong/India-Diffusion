...
%
% Programmed by "The Diffusion of Microfinance" group in 2011
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch version
    case 1 % There are 5 moments for this case.
        % Moment 1: Fraction of nodes that have no taking neighbors but are takers themselves.
        ...
        % Moment 2: Fraction of individuals that are infected in the neighborhood of infected leaders stats(1)=0;
        ...
        % Moment 3: Fraction of individuals that are infected in the neighborhood of non-infected leaders
        ...
        % Moment 4: Covariance of individuals taking with share of neighbors taking
        ...
        % Moment 5: Covariance of individuals taking with share of second neighbors taking
    ...
    case 2 % There are 3 moments.
        ...
        % Moment 2: Covariance of individuals taking with share of neighbors taking
        NonHermits = (netstats(j).degree>0);
        ShareofTakingNeighbors = infectedNeighbors(logical(NonHermits))./netstats(j).degree(logical(NonHermits));
        NonHermitTakers = infected(logical(NonHermits));
        stats(2) = sum(NonHermitTakers.*ShareofTakingNeighbors)/sum(NonHermits);
        
        % Moment 3: Covariance of individuals taking with share of second neighbors taking
        infectedSecond = sum(Sec.*(infected*ones(1,N)),2);
        ShareofSecond = infectedSecond(logical(NonHermits))./netstats(j).degree(logical(NonHermits));
    ...
    case 3
        % The same as case 2, but purged of leader injection points.
    ...
    case 4
        % The same as case 3, but purged of ALL leader nodes.
        leaderTrue = ((leaders > 0)); % a variable that denotes whether a node is either a leader
        ...
        % Moment 3: Covariance of individuals taking with share of second neighbors taking taking
